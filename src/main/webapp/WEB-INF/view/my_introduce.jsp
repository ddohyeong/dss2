...
<link rel="stylesheet" href="../css/my_introduce.css">
...
<body>
	...
	<main>
		...
		<form action="http://ec2-13-209-64-132.ap-northeast-2.compute.amazonaws.com/dss/view/introduce_update" method="POST">
			<section>
				<h2>나의 소개글</h2>
			...
			<div>
				<button type="submit" id="introduce_update">소개글 수정</button>
			</div>
		</form>
	</main>
