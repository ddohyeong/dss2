...
<body>
	...
	<main>
        <form action="">
                    ...
                    <section class="form_info1">
                        <ul class="info_row">
                            <li>
                                ...
                                <div class="nice-select wide">
                                    <span class="current" id="postCategory">프로젝트</span>
                                    <ul class="list">
                            ...
                            <li>
                                <span>모집 인원</span>
                                <div class="nice-select wide">
                                    <span class="current" id="numOfPeople">인원</span> 명
                                    <ul class="list">
                        ...
                        <ul class="info_row">
                            <li>
                                <span>진행 방식</span>
                                <div class="nice-select wide">
                                    <span class="current" id="process">오프라인</span>
                                    <ul class="list">
                            ...
                            <li>
                                <span>진행기간</span>
                                <div class="nice-select wide">
                                    <span class="current" id="period">진행 기간</span> 개월
                                    <ul class="list">
                                        <li class="option" >1</li>
                                        <li class="option" >2</li>
                                        <li class="option" >3</li>
                        ...
                        <ul class="info_row">
                            <li>
                                <span>연락 방법</span>
                                <div class="nice-select wide">
                                    <span class="current" id="contactMethod">오프라인</span>
                                    <ul class="list">
                                    	<li class="option">오프라인</li>
                            ...
                            <li>
                                ...
                                <div class="expectedStartDate_wrapper">
                                    <input class="nice-select wide" type="date" name="" id="expectedStartDate">                                
                                </div>    
                            </li>
                            ...
                            <ul>
                                <li>
                                    <div class="recruit_name">
                                        <span>게시글 제목</span>
                                        <input class="input_nice wide" id="postName" type="text">
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="recruit_introduction">
                                        <span>게시글 소개</span>
                                        <textarea name="" id="postIntroduction" cols="60" rows="10" placeholder="소개글을 입력하세요"></textarea>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div>
                <button type="submit" class="btn_style" id="post_add">게시글 작성</button>
            </div>
        </form>
    ...
    <script>
		...
		$("#post_add").on("click",function(e){
			e.preventDefault();

			let check = confirm("게시글을 등록하시겠습니까?");
			if(check){
				...
				$.ajax({
					url:"http://ec2-13-209-64-132.ap-northeast-2.compute.amazonaws.com/dss/post/add",
					type:"POST",
					data:"postName="+postName+"&postIntroduction="+postIntroduction+"&postCategory="+postCategory+"&process="+process+"&period="+period
					+"&numOfPeople="+numOfPeople+"&contactMethod="+contactMethod+"&technologyCategory="+technologyCategory+"&expectedStartDate="+expectedStartDate,
					success:function(){
						alert("등록이 완료되었습니다");
